...
public interface AssessmentRepository extends JpaRepository<Assessment, Integer> {
    @Query(value = "select a.assessment_id,ac.assessment_cate_name , a.type, a.part, a.weight, a.completion_criteria, a.duration, a.question_type, a.question_no, a.knowledge_skill, a.grading_guide, a.note, ac.assessment_cate_id, s.syllabus_id\n" +
            "from assessment a \n" +
            ...
            "join subject su on s.subject_id = s.subject_id\n" +
            "where s.syllabus_id = ?1",nativeQuery = true)
    public List<Object[]> getAssessmentBySubject(Integer syllabusId);
